...
impl EmbeddedShaders {
    pub fn new() -> Self {
        ...
        shaders.insert(
            ...
            include_str!("crt-geom.frag").to_string(),
        );
        shaders.insert(
            "crt-geom.vert".to_string(),
            include_str!("crt-geom.vert").to_string(),
        );
        shaders.insert(
            "crt-royale.frag".to_string(),
            include_str!("crt-royale.frag").to_string(),
        );
        shaders.insert(
            "crt-royale.vert".to_string(),
            include_str!("crt-royale.vert").to_string(),
        );
        ...
        shaders.insert(
            "ntsc.frag".to_string(),
            include_str!("ntsc.frag").to_string(),
        );
        shaders.insert(
            "ntsc.vert".to_string(),
            include_str!("ntsc.vert").to_string(),
        );

        // Pixel Perfect Shaders
        shaders.insert(
            "pixel-perfect.frag".to_string(),
            include_str!("pixel-perfect.frag").to_string(),
        );
        shaders.insert(
            "pixel-perfect.vert".to_string(),
            include_str!("pixel-perfect.vert").to_string(),
        );

        // Scanline Shaders
        shaders.insert(
            "scanlines.frag".to_string(),
            include_str!("scanlines.frag").to_string(),
        );
    ...
    pub fn get_shader_categories(&self) -> HashMap<String, Vec<String>> {
        ...
        // LCD Shaders
        categories.insert(
            "LCD Effects".to_string(),
            vec!["lcd.frag".to_string(), "lcd.vert".to_string()],
        );

        // Retro Effects
        categories.insert(
            "Retro Effects".to_string(),
            vec![
                "ntsc.frag".to_string(),
                "ntsc.vert".to_string(),
                "scanlines.frag".to_string(),

    ...
    pub fn show(ctx: &egui::Context, config: &mut AppConfig, open: &mut bool) -> bool {
        ...
        .show(ctx, |ui| {
            ...
            ui.horizontal(|ui| {
                ...
                if ui.selectable_label(selected_tab == 2, "History and DAT's").clicked() {
                    selected_tab = 2;
                }
            });
            ...
            match selected_tab {
                ...
                2 => {
                    // History and DAT's tab
                    ui.label("Configure paths for history and DAT files:");
                    ui.add_space(10.0);
                    ...
                    egui::ScrollArea::vertical()
                        ...
                        .show(ui, |ui| {
                            // History.xml path
                            if Self::optional_file_field(ui, "History XML", "Game history information (history.xml)", &mut config.history_path, Some(&["xml"])) {
                                changes_made = true;
                            }
                            ...
                            // MAMEInfo.dat path
                            if Self::optional_file_field(ui, "MAMEInfo DAT", "Game information and play instructions (mameinfo.dat)", &mut config.mameinfo_dat_path, Some(&["dat"])) {
                                changes_made = true;
                            }
                            ...
                            // HiScore.dat path
                            if Self::optional_file_field(ui, "HiScore DAT", "High score data for games (hiscore.dat)", &mut config.hiscore_dat_path, Some(&["dat"])) {
                                changes_made = true;
                            }
                            ...
                            // GameInit.dat path
                            if Self::optional_file_field(ui, "GameInit DAT", "Game initialization data (gameinit.dat)", &mut config.gameinit_dat_path, Some(&["dat"])) {
                                changes_made = true;
                            }
                            ...
                            // Command.dat path
                            if Self::optional_file_field(ui, "Command DAT", "Game command information (command.dat)", &mut config.command_dat_path, Some(&["dat"])) {
                                changes_made = true;
                            }
                        });
                }
            ...
            ui.horizontal(|ui| {
                ...
                if ui.button("OK").clicked() {
                    close = true;
                    // Cek jika jumlah berubah (jika kita melewatkan tracking perubahan)

...
impl AdvancedMameSettingsPOC {
    pub fn new() -> Self {
        ...
        // Sample data
        poc.rom_paths = vec!["/home/user/roms".to_string(), "/home/user/chds".to_string()];
        ...
        ui.allocate_ui_with_layout(
            ...
            |ui| {
                ...
                for (id, icon, label) in categories {
                    ...
                    let (rect, response) =
                        ui.allocate_exact_size(Vec2::new(sidebar_width, 44.0), Sense::click());
    ...
    fn render_tab_bar(&mut self, ui: &mut egui::Ui) {
        ui.horizontal(|ui| {
            ...
            let tab_bar_rect = Rect::from_min_size(tab_bar_rect.min, Vec2::new(500.0, 40.0));
        ...
        .show(ui, |ui| {
            ...
            ui.horizontal(|ui| {
                ...
                ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                    ...
                    ui.add_sized(
                        Vec2::new(280.0, 36.0),
                        egui::TextEdit::singleline(snapshot_dir).font(egui::TextStyle::Monospace),
                    );
                });
            });
            ...
            ui.horizontal(|ui| {
                ...
                ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                    ...
                    ui.add_sized(
                        Vec2::new(280.0, 36.0),
                        egui::TextEdit::singleline(config_dir).font(egui::TextStyle::Monospace),
                    );
                });
            });
            ...
            ui.horizontal(|ui| {
                ...
                ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                    ...
                    ui.add_sized(
                        Vec2::new(280.0, 36.0),
                        egui::TextEdit::singleline(nvram_dir).font(egui::TextStyle::Monospace),
                    );
                });
            });
        });
        ...
        .show(ui, |ui| {
            ...
            ui.horizontal(|ui| {
                ...
                ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                    ...
                    ui.add_sized(
                        Vec2::new(280.0, 36.0),
                        egui::TextEdit::singleline(catver_path).font(egui::TextStyle::Monospace),
                    );
                });
            });
            ...
            ui.horizontal(|ui| {
                ...
                ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                    ...
                    ui.add_sized(
                        Vec2::new(280.0, 36.0),
                        egui::TextEdit::singleline(history_path).font(egui::TextStyle::Monospace),
                    );
                });
            });
            ...
            ui.horizontal(|ui| {
                ...
                ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                    ...
                    ui.add_sized(
                        Vec2::new(280.0, 36.0),
                        egui::TextEdit::singleline(mameinfo_path).font(egui::TextStyle::Monospace),
                    );
                });
            });
            ...
            ui.horizontal(|ui| {
                ...
                ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                    ...
                    ui.add_sized(
                        Vec2::new(280.0, 36.0),
                        egui::TextEdit::singleline(command_path).font(egui::TextStyle::Monospace),
                    );
                });
            });
        });

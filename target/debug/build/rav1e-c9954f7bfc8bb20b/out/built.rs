...
#[allow(dead_code)]
pub static RUSTC_VERSION: &str = "rustc 1.88.0 (6b00bc388 2025-06-23) (Arch Linux rust 1:1.88.0-1.1)";
#[doc=r#"The output of `rustdoc -V`; empty string if `rustdoc -V` failed to execute"#]
#[allow(dead_code)]
pub static RUSTDOC_VERSION: &str = "rustdoc 1.88.0 (6b00bc388 2025-06-23) (Arch Linux rust 1:1.88.0-1.1)";
